        ...
        try:
            ...
            if risk >= RISK_THRESHOLD:
                ...
                if optimizer.validate_syntax(new_code):
                    ...
                    # ✅ SAFE UI CALL (MAIN THREAD via queue)
                    self.popup_queue.put(new_code)
...
def start_watching(directory, popup_queue):
    observer = Observer()
    observer.schedule(CodeEventHandler(popup_queue), path=directory, recursive=True)
